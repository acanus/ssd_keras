...
def ssd_mobilenet_300(mode,
    ...
    mobilenet_v1_model = tensorflow.keras.applications.MobileNet(
    alpha=1.0,
    depth_multiplier=1,
    dropout=0.001,
    include_top=False,
    ...
    conv4_3_norm = mobilenet_v1_model.get_layer('conv_pw_11_relu').output
    fc7 = mobilenet_v1_model.get_layer('conv_pw_13_relu').output
